...
CharCode charCodes[256] = {
    ...
    CHAR_SPACE, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_SINGLEQUOTE,
    ...
    CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER,
    CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_MONGOACVUONG, CHAR_UNKNOWN, CHAR_DONGNGOACVUONG, CHAR_UNKNOWN, CHAR_UNKNOWN,
